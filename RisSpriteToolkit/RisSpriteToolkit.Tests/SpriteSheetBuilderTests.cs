...
namespace RisGameFramework.SpriteToolkit.Tests
{
    ...
    internal class SpriteSheetBuilderTests
    {
        ...
        /// It should be 6 images that need to be added the <see cref="SpriteSheetBuilder"/>.
        /// </summary>
        [Test]
        ...
        /// <summary>
        /// Test saving a raw image which should be returned by <see cref="SpriteSheetBuilder.Save"/> method.
        /// </summary>
        [Test]
        public void Test_Save_RawImage()
        {
            SpriteSheetBuilder builder = new(new System.Drawing.Size(1,1));
            builder.Padding = 0; // No padding for this test
